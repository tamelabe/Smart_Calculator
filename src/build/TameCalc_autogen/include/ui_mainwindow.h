...
"background-color : white;"));
        ...
        spinBox_XS->setMinimum(-1000);
        spinBox_XS->setMaximum(1000);
        spinBox_XS->setValue(-30);
        ...
        spinBox_XF->setMinimum(-1000);
        spinBox_XF->setMaximum(1000);
        spinBox_XF->setValue(30);
        ...
        spinBox_YS->setMinimum(-1000);
        spinBox_YS->setMaximum(1000);
        spinBox_YS->setValue(-30);
        ...
        spinBox_YF->setMinimum(-1000);
        spinBox_YF->setMaximum(1000);
        spinBox_YF->setValue(30);
...
#endif // QT_CONFIG(tooltip)
        butt_sq_root->setText(QCoreApplication::translate("MainWindow", "sqrt", nullptr));
#if QT_CONFIG(shortcut)
